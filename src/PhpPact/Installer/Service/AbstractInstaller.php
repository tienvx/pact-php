...
{
    const PACT_RUBY_STANDALONE_VERSION = '1.88.24';
    const PACT_FFI_VERSION             = '0.0.0';
    const PACT_STUB_SERVER_VERSION     = '0.4.4';
    ...
    private function extractGz(string $sourceFile, string $fileName, bool $executable): void
    {
        ...
        \gzclose($file);
        if ($executable) {
            // TODO How to change permission to executable in Windows
            \chmod($destFile, 0744);
        }
    }
