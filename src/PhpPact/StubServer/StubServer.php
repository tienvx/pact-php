...
use PhpPact\Process\ProcessRunner;
use PhpPact\StubServer\Model\StubServerConfigInterface;
...
class StubServer
{
    ...
    {
        $this->processRunner = new ProcessRunner($this->installManager->getScripts()->getStubService(), $this->getArguments());
