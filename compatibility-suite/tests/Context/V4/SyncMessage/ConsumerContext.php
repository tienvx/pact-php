...
use PhpPactTest\CompatibilitySuite\Service\SyncMessageGeneratorBuilderInterface;
...
final class ConsumerContext implements Context
{
    ...
    public function __construct(
        ...
        private SyncMessageGeneratorBuilderInterface $generatorBuilder,
    ...
    public function theMessageRequestPayloadContainsTheJsonDocument(string $fixture): void
    {
        ...
        //$this->message->setRequestContents($this->fixtureLoader->load($fixture . '.json'));
        //$this->message->setRequestContents($this->parser->parseBody('file:' . $fixture . '.json'));
    }
    ...
    {
        // $name = str_replace('file: ', '', $fixture);
        // $this->message->addResponseContents($this->fixtureLoader->loadXml($name));
    ...
    {
        // $name = str_replace('file: ', '', $fixture);
        // Assert::assertStringContainsString($this->fixtureLoader->load($name), $this->response->getBody());
        ...
        // $expectedContent = method_exists($expectedBody, 'getRawContents') ? $expectedBody->getRawContents() : $expectedBody->getContents();
    ...
    public function theMessageRequestIsConfiguredWithTheFollowing(TableNode $table): void
    {
        ...
        if (isset($row['generators'])) {
            $this->generatorBuilder->buildRequest($this->message, $row['generators']);
        }
    }
    ...
    public function theMessageResponseIsConfiguredWithTheFollowing(TableNode $table): void
    {
        ...
        if (isset($row['generators'])) {
            $this->generatorBuilder->buildResponse($this->message, $row['generators']);
        }
    }
    ...
    public function theMessageIsSuccessfullyProcessed(): void
    {
        ...
        // $this->response = $client->request('POST', $this->config->getBaseUri(), [
        //     'body' => $body,
        //     'http_errors' => false,
        // ]);
    }
